...
from evonn_primordia.benchmarks.spec import BenchmarkSpec
...
_CATALOG_ENV_VAR = "PRIMORDIA_CATALOG_DIR"
...
def get_benchmark(name: str, catalog_dir: Path | None = None) -> BenchmarkSpec:
    ...
    """
    from evonn_primordia.benchmarks.parity import get_native_id
