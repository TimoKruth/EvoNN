...
_TABULAR = {
    ...
    "ridge": _spec("ridge", "linear", "tabular", backend="sklearn_regressor", task_kind="regression"),
    "ridge_or_linear": _spec("ridge_or_linear", "linear", "tabular", backend="sklearn_regressor", task_kind="regression"),
    ...
    "linear_svr": _spec("linear_svr", "svm", "tabular", backend="sklearn_regressor", task_kind="regression"),
    "svr": _spec("svr", "svm", "tabular", backend="sklearn_regressor", task_kind="regression"),
    "svr_or_nystroem_svr": _spec("svr_or_nystroem_svr", "svm", "tabular", backend="sklearn_regressor", task_kind="regression"),
