...
from evonn_compare.orchestration.evidence_registry import promote_evidence, validate_registry
...
def _write_summary(workspace: Path, *, seed: int, prism_score: float, topograph_score: float) -> None:
    summary_dir = workspace / "reports" / f"tier_b_core_v2_eval96_seed{seed}"
