...
LANE_PRESETS: dict[str, LanePreset] = {
    ...
    "tier_a_smoke_cumulative": LanePreset(
        name="tier_a_smoke_cumulative",
        pack="tier_a_contract_cumulative",
        seeds=(42,),
        budgets=(16,),
        description="Cumulative Tier A smoke lane; alias for the Tier A contract smoke pack.",
    ),
    "tier_a_contract_cumulative": LanePreset(
        name="tier_a_contract_cumulative",
        pack="tier_a_contract_cumulative",
        seeds=(42,),
        budgets=(64,),
        description="Cumulative Tier A contract lane; alias for the Tier A contract pack.",
    ),
    "tier_b_local_v2": LanePreset(
        ...
        seeds=(42,),
        budgets=(96,),
        description="Expanded Tier B-only local research increment with required contender floors.",
    ),
    ...
    "tier_b_local_v2_cumulative": LanePreset(
        name="tier_b_local_v2_cumulative",
        pack="tier_b_core_v2_cumulative",
        seeds=(42,),
        budgets=(98,),
        description="Cumulative Tier A+B local lane for one-shot comparisons through Tier B.",
    ),
    "tier_b_overnight_v2_cumulative": LanePreset(
        name="tier_b_overnight_v2_cumulative",
        pack="tier_b_core_v2_cumulative",
        seeds=(42,),
        budgets=(392,),
        description="Cumulative Tier A+B overnight lane.",
    ),
    "tier_b_extended_v2_cumulative": LanePreset(
        name="tier_b_extended_v2_cumulative",
        pack="tier_b_core_v2_cumulative",
        seeds=(42,),
        budgets=(784,),
        description="Cumulative Tier A+B extended lane.",
    ),
    "tier_b_weekend_v2_cumulative": LanePreset(
        name="tier_b_weekend_v2_cumulative",
        pack="tier_b_core_v2_cumulative",
        seeds=(42,),
        budgets=(1568,),
        description="Cumulative Tier A+B weekend lane.",
    ),
    ...
    "tier_c_local_cumulative": LanePreset(
        name="tier_c_local_cumulative",
        pack="tier_c_architecture_sensitive_cumulative",
        seeds=(42,),
        budgets=(132,),
        description="Cumulative Tier A+B+C local lane.",
    ),
    "tier_c_overnight_cumulative": LanePreset(
        name="tier_c_overnight_cumulative",
        pack="tier_c_architecture_sensitive_cumulative",
        seeds=(42,),
        budgets=(528,),
        description="Cumulative Tier A+B+C overnight lane.",
    ),
    "tier_c_extended_cumulative": LanePreset(
        name="tier_c_extended_cumulative",
        pack="tier_c_architecture_sensitive_cumulative",
        seeds=(42,),
        budgets=(1056,),
        description="Cumulative Tier A+B+C extended lane.",
    ),
    "tier_c_weekend_cumulative": LanePreset(
        name="tier_c_weekend_cumulative",
        pack="tier_c_architecture_sensitive_cumulative",
        seeds=(42,),
        budgets=(2112,),
        description="Cumulative Tier A+B+C weekend lane.",
    ),
    "tier_d_local": LanePreset(
        ...
        seeds=(42,),
        budgets=(200,),
        description="Special-only Tier D increment lane at the lowest admitted Tier D-only budget.",
    ),
    "tier_d_broad": LanePreset(
        ...
        seeds=(42,),
        budgets=(400,),
        description="Special-only Tier D increment lane; keep separate until repeated clean runs exist.",
    ),
    "tier_d_overnight": LanePreset(
        ...
        seeds=(42,),
        budgets=(800,),
        description="Special-only Tier D increment overnight lane; keep separate until repeated clean runs exist.",
    ),
    "tier_d_weekend": LanePreset(
        ...
        seeds=(42,),
        budgets=(1600,),
        description="Special-only Tier D increment weekend lane; keep separate until repeated clean runs exist.",
    ),
    "tier_d_local_cumulative": LanePreset(
        name="tier_d_local_cumulative",
        pack="tier_d_broad_shared_cumulative",
        seeds=(42,),
        budgets=(216,),
        description="Cumulative Tier A+B+C+D local lane for full admitted benchmark comparisons.",
    ),
    "tier_d_broad_cumulative": LanePreset(
        name="tier_d_broad_cumulative",
        pack="tier_d_broad_shared_cumulative",
        seeds=(42,),
        budgets=(432,),
        description="Cumulative Tier A+B+C+D broad lane.",
    ),
    "tier_d_overnight_cumulative": LanePreset(
        name="tier_d_overnight_cumulative",
        pack="tier_d_broad_shared_cumulative",
        seeds=(42,),
        budgets=(864,),
        description="Cumulative Tier A+B+C+D overnight lane.",
    ),
    "tier_d_weekend_cumulative": LanePreset(
        name="tier_d_weekend_cumulative",
        pack="tier_d_broad_shared_cumulative",
        seeds=(42,),
        budgets=(1728,),
        description="Cumulative Tier A+B+C+D weekend lane.",
    ),
}
