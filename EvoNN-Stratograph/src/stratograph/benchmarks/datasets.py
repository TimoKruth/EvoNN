"""Built-in benchmark registry for Stratograph."""
...
_BUILTIN_BENCHMARKS: dict[str, BenchmarkSpec] = {
    ...
    "tiny_lm_synthetic": BenchmarkSpec(
        name="tiny_lm_synthetic",
    ...
    "tinystories_lm": BenchmarkSpec(
        name="tinystories_lm",
        task="language_modeling",
        source="lm_cache",
        dataset="tinystories_lm",
        input_dim=256,
        num_classes=8192,
        max_train_samples=4096,
        max_val_samples=512,
    ),
    "tinystories_lm_smoke": BenchmarkSpec(
        name="tinystories_lm_smoke",
        task="language_modeling",
        source="lm_cache",
    ...
    "wikitext2_lm": BenchmarkSpec(
        ...
        task="language_modeling",
        source="lm_cache",
        dataset="wikitext2_lm",
        input_dim=256,
        num_classes=32768,
        max_train_samples=4096,
        max_val_samples=512,
    ),
    "wikitext2_lm_smoke": BenchmarkSpec(
        name="wikitext2_lm_smoke",
        task="language_modeling",
        source="lm_cache",
...
def get_benchmark(name: str) -> BenchmarkSpec:
    ...
    try:
        ...
        raise KeyError(f"Unknown Stratograph benchmark: {name}") from exc
